...
// Fase Octavos: colección propia para que el ranking arranque desde cero.
// Los resultados de fases previas quedan intactos ("results" grupos, "results_16vos").
const COLLECTION = "results_octavos";
